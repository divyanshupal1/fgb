...
export const LoadingScreen = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full h-screen  bg-neutral-800 bg-opacity-80 flex justify-center items-center'>
        <div className='flex justify-center items-center animate-bounce'>
            ...
            <div className='p-1'>
                ...
                <rect width="64" height="64" rx="32" fill="black" fill-opacity="0.95"/>
                ...
                <stop offset="0.426041" stop-color="white"/>
                <stop offset="0.613541" stop-color="white"/>
